...
validate_recipe_outputs "python-chromedriver-binary-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="python-chromedriver-binary-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi