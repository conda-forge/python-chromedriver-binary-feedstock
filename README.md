...
Home: https://pypi.org/project/chromedriver-binary

Package license: MIT

Summary: Downloads and installs the chromedriver binary version

Development: https://github.com/danielkaiser/python-chromedriver-binary
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-chromedriver-binary-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-chromedriver-binary-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5711&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-chromedriver-binary-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_arm64</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5711&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-chromedriver-binary-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add python-chromedriver-binary
# for installing globally
pixi global install python-chromedriver-binary
```
...
It is possible to list all of the versions of `python-chromedriver-binary` available on your platform:
...
```
pixi search python-chromedriver-binary --channel conda-forge
```
